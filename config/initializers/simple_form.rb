...
SimpleForm.setup do |config|
  ...
  # u can define d class to use on all collection wrappers. Defaulting to none.
  ...
  # type as key and the wrapper that will be used for
  # all inputs with specified type.
